/* ============================================================
   TextForge Studio — icons
   Lucide-style line icons drawn fresh for the IDE.
   ============================================================ */
...
const Icon = ({ name, size = 16, stroke = 1.5, ...rest }) => {
  ...
  switch (name) {
    ...
    case "tilde":
      return (
        <svg {...base}>
          <path d="M3 13c2-3 5-3 7 0s5 3 7 0 5-3 4 0" />
        </svg>
      );
    case "circle":
      return (
    ...
    default:
      return <svg {...base}><circle cx="12" cy="12" r="6" /></svg>;
  }
};
